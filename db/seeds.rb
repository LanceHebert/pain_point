...
e9=Exercise.create!(recsets:3,stretch:false,recreps:20,videoEmbed:"v5bPOsQbq7g",advanced:false,name:"Sidelying External Rotation with Towel",description:"Lie on your side with your elbow bent to 90 degrees. Place a rolled up towel between your arm and the side your body as shown. 
...
e10=Exercise.create!(recsets:3,stretch:false,recreps:20,videoEmbed:"IxLuC-Bw8T4",advanced:false,name:"Cane External Rotation Stretch",description:"Lie on your back with a pillow under your affect shoulder. Hold a cane or wand with both hands.
...
e29=Exercise.create!(recsets:3,stretch:false,recreps:20,videoEmbed:"AVAXhy6pl7o",advanced:true,name:"Single Leg Bridge",description:"While lying on your back with your knees bent, extend one knee as shown. Next, raise your buttocks off the floor/bed.Try and maintain your pelvis level the entire time. ",muscle_group_id:m3.id)
...
e32=Exercise.create!(recsets:3,stretch:false,recreps:20,videoEmbed:"n4CYxMr_D6s&t=87s",advanced:true,name:"PNF with Theraband",description:"Standing with the band anchored under 1 foot and grasping the other end of the band at the office in hand in the thumb down position and all the slack taken out of the band. Lift your arm out to the side and over your head while rotating your head and trunk in that direction. Return to the beginning position ",muscle_group_id:m2.id)
